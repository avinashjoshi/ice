...
$db_query = "INSERT INTO `{$table}` (DName, DeptHead, Location, Phone) VALUES
	...
	( 'Physics', '9211114423', 'ECSS', '9876543210' )
	;";
if( !mysql_query( $db_query ) ){
	messagePush( "Table could not be created<br />SQL: ".mysql_error() );
	pageReload();
...
$db_query = "INSERT INTO `{$table}` VALUES
	...
	( '211114423', 'Mary', 'L', 'Urquhart', 'urquhart', '1958-01-09', 'UTDallas', 'F', '40000', 'urquhart@utdallas.edu', 'FN 3.308', 'Assoc Prof/Department Head', '9728832499', 2 ),
...
$db_query = "INSERT INTO `{$table}` VALUES
	...
	( 'PHYS6300', 'Quantum Mechanics I', 'QM in depth', 3, 3 ),
...
$table = "section";
$db_query = "INSERT INTO `{$table}` (CRN, CNo, SecNo, SecName, SemYear, InstSsn) VALUES
	( '81476', 'CS6371', '001', '', '11f', '999887777' ),
	( '83740', 'PHYS6300', '001', '', '11f', '211114423' ),
	( '84505', 'CS6360', '003', '', '11f', '123456789' ),
	( '84504', 'CS6360', '002', '', '11f', '888665555' ),
	( '85691', 'CS6363', '004', '', '11f', '333445555' ),
	( '21245', 'CS6363', '001', '', '12s', '123456789' ),
	( '12720', 'CE4348', '001', '', '10f', '666884444' )
	;";
if( !mysql_query( $db_query ) ){
	messagePush( "Table could not be created<br />SQL: ".mysql_error() );
	pageReload();
